                        ...
                        <div class="border p-3 bg-light">
                            <div class="row">
                                <div class="form-group mt-3 col-sm-12 col-md-6">
                                    ...
                                    <input id="writer2" type="text" name="writer2" class="form-control" placeholder="Nama Penulis 2">
                                </div>
                                <div class="form-group mt-3 col-sm-12 col-md-6">
                                    <label for="email2">Email Penulis 2 <span class="text-danger"></span></label>
                                    <input id="email2" type="email" name="email2" class="form-control" placeholder="Email Penulis 2">
                                </div>
                            </div>
                        </div>
                    </div>
