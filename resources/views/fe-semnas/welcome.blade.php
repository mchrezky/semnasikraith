  ...
  <section id="hero" class="hero section dark-background">
    ...
    <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active">
        <img src="{{ asset('assets/img/event/pic1.jpg') }}" alt="">
      ...
      <div class="carousel-item">
        <img src="{{ asset('assets/img/event/pic2.jpg') }}" alt="">
        <div class="carousel-container">
      ...
      <div class="carousel-item">
        <img src="{{ asset('assets/img/event/pic3.jpg') }}" alt="">
        <div class="carousel-container">
      ...
      <div class="carousel-item">
        <img src="{{ asset('assets/img/event/pic4.jpg') }}" alt="">
        <div class="carousel-container">
      ...
      <div class="carousel-item">
        <img src="{{ asset('assets/img/event/pic5.jpg') }}" alt="">
        <div class="carousel-container">
